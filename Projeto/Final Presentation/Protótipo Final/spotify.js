document.addEventListener("DOMContentLoaded", function() {
    ...
    avancarDiv.addEventListener('click', function() {
        ...
        if(audio.paused){
            ...
            imageaudio.src = "assets/the script.png"; // Altera a imagem ao avançar para "superheroes"
            audio.src = "assets/superheroes.mp3";        // Defina o src do elemento de áudio para a música "superheroes
    ...
    retrocederDiv.addEventListener('click', function() {
        // Defina o src do elemento de áudio para a música "superheroes"
        if(audio.paused){
            playImage.src = "assets/play.png";
            imageaudio.src = "assets/coldplay album.png"; // Altera a imagem ao avançar para "superheroes"
            audio.src = "assets/higher-power.mp3";        // Defina o src do elemento de áudio para a música "superheroes"
